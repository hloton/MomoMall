...
<header class="andro_header header">
    <div class="andro_header-middle">
        <div class="container">
          ...
          <h3>个人注册</h3></span>
                <span class="navbar-brand ">已有帐号？请
        <a href="login.jsp">
          登录
      </a>
        </span>
    ...
    <div class="container">
        <div class="andro_auth-wrapper">
            ...
            <div class="andro_auth-form">
                <h2>注册</h2>
                <div class="form-register-type">
                    <div  id="username-register"  class="register-type selected-type">用户名注册</div>
                    <div id="phone-register" class="register-type">手机号注册</div>
                </div>
                <form method="post" id="username-register-form" action="Register">
                    ...
                    <button type="submit" class="andro_btn-custom primary">注册</button>
                </form>

                <form method="post" id="phone-register-form" style="display: none;" action="Register">
