            ...
            <div class="diagram_content">
                <table class="table table-bordered table-hover text-center">
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-primary">查看订单</button>
                            <button class="btn btn-danger">关闭订单</button></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox"></td>
                        <td>202312178829937</td>
                        ...
                        <td><button class="btn btn-primary">查看订单</button>
                            <button class="btn btn-success">订单发货</button></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox"></td>
                        <td>202312178829937</td>
                        ...
                        <td><button class="btn btn-primary">查看订单</button>
                            <button class="btn btn-primary">订单跟踪</button></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox"></td>
                        <td>202312178829937</td>
                    ...
                    <tr>
                        ...
                        <td><button class="btn btn-primary">查看订单</button>
                            <button class="btn btn-success">订单发货</button></td>                    </tr>
                    <tr>
                        <td><input type="checkbox"></td>
                        <td>202312178829937</td>
                        <td>2023-12-17 13:23</td>
