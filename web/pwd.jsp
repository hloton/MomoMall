                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-widget widget-about-author">
                        <div class="widget-about-author-inner">
                            <img src="<%=((User)session.getAttribute("userinfo")).getAvatar()%>" alt="author">
                            <h5><%=((User)session.getAttribute("userinfo")).getUname()%></h5>
                            <p></p>
                        ...
                        <form action="${pageContext.request.contextPath}/changePassword" method="post">
                            ...
                            <h4 class="">修改密码</h4>
                                <div class="form-group" style="display: flex; align-items: center;justify-content : center;" >
                                    <label  class="mr-3">输入密码</label>
                                    <input type="password" class="form-control "style="width:70%" name="password">
                                </div>
                                <div class="form-group" style="display: flex; align-items: center;justify-content : center;" >
                                    <label class="mr-3">确认密码</label>
                                    <input type="password" class="form-control "style="width:70%" name="confirmPassword">
                                </div>
                                <div class="form-group" style="display: flex; align-items: center;justify-content : center;" >
                                    <label class="mr-3">手机号</label>
                                    <input type="text" class="form-control "style="width:50%" name="phone" value="<%=((User)session.getAttribute("userinfo")).getUph()%>">
                                    <button type="button" class="btn btn-success ml-3">获取验证码</button>
                                </div>
                                <div class="form-group" style="display: flex; align-items: center;justify-content : center;" >
                                    <label class="mr-3">验证码</label>
                                    <input type="text" class="form-control "style="width:70%" name="verificationCode">
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="andro_btn-custom primary btn-block">保存</button>
                                </div>
                        </form>
                    </div>
