            ...
            <nav class="navbar">
                ...
                <div class="andro_header-controls">
                    <ul class="andro_header-controls-inner">
                        <li class="andro_header-favorites"> <a href="#" title="我的账户"> <i class="fa-regular fa-user "></i> </a> </li>
                        ...
                        <form action="${pageContext.request.contextPath}/updateUserInfo" method="post">
                            ...
                            <h4 class="">个人信息</h4>
                                <div class="form-group" style="display: flex; align-items: center;justify-content : center;" >
                                    <label  class="mr-3">用户名</label>
                                    <input type="text" class="form-control "style="width:70%"  name="username" value="<%=((User)session.getAttribute("userinfo")).getUname()%>">
                                </div>
                                <div class="form-group" style="display: flex; align-items: center;justify-content : center;" >
                                    <label class="mr-3">手机号</label>
                                    <input type="text" class="form-control "style="width:70%" name="phone" value="<%=((User)session.getAttribute("userinfo")).getUph()%>">
                                </div>
                                <div class="form-group" style="display: flex; justify-content : center; align-items: center;" >
                                    <label class="mr-3">性别</label>
                                    <span style="width:70%;"  ><label for="male"class="mr-3"> <input type="radio" class=" " name="gender"  value="male" id="male" >男</label>
                <label for="female"class="mr-3"> <input type="radio" class=" " name="gender"  value="male" id="female" >女</label></span>
